...
class CodexCliCodingProvider:
    ...
    def submit_task(self, request):
        ...
        schema_path, result_path = control / "schema.json", control / "result.json"
    ...
    def _prompt(self, request):
        ...
        return (
            ...
            "requested complete UTF-8 file operations in JSON. Do not use Git, commit, push, "
    ...
    def _parse(self, request, raw):
        ...
        if set(value) != {"status", "summary", "file_operations", "progress", "diagnostics"}:
        ...
        for item in value["file_operations"]:
            if set(item) != {"operation_type", "path", "content", "expected_prior_digest"}:
                raise ProviderStateError("Unexpected file operation fields")
            if item["operation_type"] == "DELETE":
                raise ProviderStateError("Unexpected deletion from Codex CLI")
            try:
            ...
            operations.append(FileOperation(FileOperationKind(item["operation_type"]), path,
                                            content, item["expected_prior_digest"]))
        ...
        return ProviderTaskResult(
            ...
            tuple(operations), tuple(value["progress"]), (), (),
...
_RESULT_SCHEMA = {
    ...
    "required": ["status", "summary", "file_operations", "progress", "diagnostics"],
    "properties": {
        "status": {"type": "string", "enum": ["SUCCEEDED", "FAILED_RETRYABLE", "FAILED_PERMANENT", "TIMED_OUT", "CANCELLED"]},
        "summary": {"type": "string"},
        "file_operations": {"type": "array", "items": {
            "type": "object", "additionalProperties": False,
            "required": ["operation_type", "path", "content", "expected_prior_digest"],
            "properties": {"operation_type": {"type": "string", "enum": ["CREATE", "UPDATE", "DELETE"]},
                           "path": {"type": "string"}, "content": {"type": "string"},
                           "expected_prior_digest": {"type": ["string", "null"]}}}},
