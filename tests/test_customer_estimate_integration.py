...
def test_real_customer_generates_and_reopens_traceable_delivery_estimate(tmp_path):
    ...
    try:
        with playwright.sync_playwright() as runtime:
            ...
            assert page.get_by_text("28–40 engineering days", exact=False).first.is_visible()
    ...
    assert (estimate.total_minimum_effort_days, estimate.total_maximum_effort_days) == (28, 40)
